...
def view_File(count,count1,count2):
    ...
    label1 = tk.Label(window1 , text = "DELETED FILES", bg = "powder blue", fg = "dark blue")
    label1.pack(fill = "x")

    
    tex = tk.Listbox(master=window1,width=150,height=30,bg='light gray',font=('Arial', 8, 'bold'),bd='7')
    ...
    tex.place(x=30,y=30)
    tex1.place(x=30,y=600)
    tex.config(yscrollcommand=scr.set, font=('Arial', 8, 'bold', 'italic'))


   
    print("Number of deleted Files:",count1)
